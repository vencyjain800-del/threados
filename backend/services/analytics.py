"""Forecasting, buy recommendation, and risk classification services."""
import statistics
...
def forecast_from_history(sales_rows: list[dict]) -> dict:
    """sales_rows sorted ascending by date, each with 'units'."""
...
def recommend_buy(sku: dict, fc: dict) -> dict:
    ...
    return {
        ...
        "days_of_stock": round(min(999.0, days_of_stock), 1),
...
RISK_LABELS = {
    "high_stockout": "High Stockout Risk",
    "medium_stockout": "Medium Stockout Risk",
    "healthy": "Healthy Inventory",
    "medium_overstock": "Medium Overstock Risk",
    "high_overstock": "High Overstock Risk",
}
...
async def build_full_sku_analytics(db, sku: dict) -> dict:
    ...
    # 30d units sold + best-seller signal

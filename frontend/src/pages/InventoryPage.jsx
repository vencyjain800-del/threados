...
export default function InventoryPage() {
  ...
  useEffect(() => {
    let active = true;
    setLoading(true);
    const params = { category, risk, sort };
    if (q) params.q = q;
    api
      .get("/products", { params })
  ...
  return (
    <div data-testid="inventory-page">
      ...
      <Card className="mb-4">
        <CardContent className="p-4 flex flex-col md:flex-row gap-3 md:items-center">
          ...
          <Select value={category} onValueChange={setCategory}>
            <SelectTrigger className="w-full md:w-[180px]" data-testid="inventory-category-select">
          ...
          <Select value={risk} onValueChange={setRisk}>
            <SelectTrigger className="w-full md:w-[210px]" data-testid="inventory-risk-select">
          ...
          <Select value={sort} onValueChange={setSort}>
            <SelectTrigger className="w-full md:w-[210px]" data-testid="inventory-sort-select">
            ...
            <table className="w-full text-sm" data-testid="inventory-table">
              ...
              <tbody>
                {loading
                  ...
                  : (
                      <tr>
                        <td colSpan={9} className="px-4 py-12 text-center text-sm text-muted-foreground" data-testid="inventory-empty-state">
                          No SKUs match your filters. Try clearing risk or category filters.
                        </td>
                      </tr>
                    )}
              </tbody>
      ...
      <div className="mt-3 text-xs text-muted-foreground">
        {loading ? "" : `${num(data?.total || 0)} SKUs shown`}
      </div>
    </div>
  );
}
